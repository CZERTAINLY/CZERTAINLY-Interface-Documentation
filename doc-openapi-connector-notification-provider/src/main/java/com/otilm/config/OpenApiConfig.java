...
public class OpenApiConfig {
    ...
    @Bean
    public GroupedOpenApi notificationProviderApis() {
        return GroupedOpenApi.builder()
        		.group("connector-notification-provider")
    ...
    @Bean
    public OpenAPI notificationProviderOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("Notification Provider API")
                        .description("REST API for implementations of custom Notification Provider")
                        .version(version)
                        .license(new License()
                                .name("MIT License")
