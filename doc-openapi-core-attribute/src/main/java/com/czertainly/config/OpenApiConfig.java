...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI attributeOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("CZERTAINLY Attribute API")
                        .description("REST API for managing Custom attributes and global metadata in the platform")
                        .version(version)
                        .license(new License()
                                .name("MIT License")
