...
public interface SettingControllerDummy extends AuthProtectedController {

    class PlatformSettingsDto extends com.czertainly.api.model.core.settings.PlatformSettingsDto {
