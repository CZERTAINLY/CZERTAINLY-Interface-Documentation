...
public class OpenApiConfig {
    ...
    @Bean
    public GroupedOpenApi secretProviderApis() {
        return GroupedOpenApi.builder()
                .group("connector-secret-provider")
    ...
    @Bean
    public OpenAPI secretProviderOpenAPI() {
        ...
        logoExtension.put("x-metrics-profile", MetricsController.METRICS_CONFIG);

        return new OpenAPI()
                .info(new Info().title("Secret Provider API")
                        .description("REST API for implementations of custom Secret Provider")
                        .version(version)
                        .license(new License()
                                .name("MIT License")
