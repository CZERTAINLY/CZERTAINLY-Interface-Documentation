...
public class OpenApiConfig {
    ...
    @Bean
    public GroupedOpenApi vaultProfileApis() {
        return GroupedOpenApi.builder()
        		.group("core-vault-profile")
    ...
    public OpenAPI raProfileOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("Vault Profile API")
                        .description("REST API for managing Vault Profiles in the platform")
                        .version(version)
                        .license(new License()
                                .name("MIT License")
