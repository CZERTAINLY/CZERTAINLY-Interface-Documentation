...
public class OpenApiConfig {
    ...
    public GroupedOpenApi discoveryProviderApis() {
        return GroupedOpenApi.builder()
        		.group("connector-compliance-provider-v2")
    ...
    @Bean
    public OpenAPI discoveryProviderOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("CZERTAINLY Compliance Provider v2 API")
                        .description("REST API for implementations of custom v2 Compliance Provider")
                        .version(version)
                        .license(new License()
                                .name("MIT License")
