...
public class OpenApiConfig {
    ...
    public OpenAPI discoveryOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("CZERTAINLY Compliance Profile API")
                        .description("REST API for managing Compliance Profiles in the platform")
                        .version(version)
                        .license(new License()
                                .name("MIT License")
